    ...
    <section className="mt-12">
      <article className="">
        <div className="text-center">
          ...
          <h3 className="font-man text-[3rem]">
            Handshake infographic mass market crowdfunding iteration.
          </h3>
        </div>
        <article className="flex gap-4 justify-between mt-14">
                ...
                <div className="flex justify-between">
                  <div className="">
                    ...
                    <div className=" py-4 pr-5">
                      <h4 className="font text-[1.5rem]">{service.title}</h4>
...
export const Service2 = () => {
  return (
    <article className="mt-20 mb-14 font-sans">
      <div className="flex justify-between items-center">
        <div className="relative">
          <Image src={image4} alt="service" width={450} height={480}></Image>
          <div className="absolute m-auto  left-[50%] z-[4] bg-white -translate-y-[14rem] p-4 shadow-md rounded-[12px]">
            <Image src={bars} alt="service" width={170} height={170}></Image>
        ...
        <div className="w-[45%]">
          <h3 className="font-man text-[2.25rem]">
...
export const Service3 = () => {
  return (
    <article className="mt-32 mb-14 font-sans">
      <div className="flex justify-between items-center">
        <div className="w-[45%]">
          <h3 className="font-man text-[2.25rem]">
            We connect our customers with the best, and help them keep up-and
        ...
        <div className="relative font-man">
          <Image src={image5} alt="service" width={450} height={480}></Image>
          <div className="absolute m-auto font-man  right-[45%] z-[4] bg-white -translate-y-[13rem] p-4 shadow-md rounded-[12px] ">
